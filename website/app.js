...
const WEATHER_API_BASE_URL = 'https://api.openweathermap.org/data/2.5/weather?units=imperial&id=mustafa&appid=df5ac90d29a68a0300a7df0abe2d872f&';
...
const getWeatherData = async function (zipcode = 94040) {
  try {
    // construct URL
    const url = `${WEATHER_API_BASE_URL}zip=${zipcode}`;
